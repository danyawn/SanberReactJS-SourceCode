...
export const GlobalProvider = (props) => {
        ...
        .post(
          ...
          { title, job_description, job_qualification, job_type, job_tenure, job_status, company_name, company_image_url, company_city, salary_min, salary_max },
          {
            headers: {
              Authorization:
                "Bearer " +
                "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..fO-qz7xpIhy4oVoLGi5yPCH_jWiB8Qi0zW9jIVjT458",
            },
          }
        )
        .then((res) => {
  ...
  const handleEdit = (event) => {
    ...
    axios.get(`https://dev-example.sanbercloud.com/api/job-vacancy/${ID_GAMES} `).then((res) => {
      let data = res.data;
