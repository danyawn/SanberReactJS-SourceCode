...
const CreateData = () => {
  ...
  const { data, setData, fetchStatus, setFetchStatus, currentId, setCurrentId, input, setInput, handleInput, handleSubmit, handleDelete, handleEdit } = state;

  let { ID_GAMES } = useParams();

  useEffect(() => {
    if (ID_GAMES !== undefined) {
      axios.get(`https://backendexample.sanbercloud.com/api/mobile-apps/${ID_GAMES}`).then((res) => {
        let data = res.data;
    ...
    <>
      ...
      <div className=" ">
        ...
        <div className="container pt-10 ml-20 ">
          {/* Table */}
          <div className="">
            <div className="m-auto mt-20 mb-11 w-[80%]">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4  ">
                <div className="mb-2 block container px-10">
                  ...
                  <input
                    ...
                    name="salary_min"
                    type="number"
                    class="bg-gray-50 border border-gray-300 tenumberray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[100%] p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required={true}
                  />
                  <br />
