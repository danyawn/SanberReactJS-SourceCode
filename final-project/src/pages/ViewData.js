  ...
  return (
    <>
      ...
      <div className=" ">
        <Sidebar />
        {/* Content */}
        <div className="container pt-24 ml-20 ">
          {/* Table */}
          <div className="">
            <div className="  grid justify-center mb-5 px-10 py-7">
              ...
              <Table class="sm:rounded-full">
                <Table.Head class="bg-purple-600 text-white">
                  ...
                  <Table.HeadCell>Job Description</Table.HeadCell>
                  <Table.HeadCell>Job Qualification</Table.HeadCell>
                  <Table.HeadCell>Job Type</Table.HeadCell>
                  <Table.HeadCell>Job Tenur</Table.HeadCell>
                      ...
                      return (
                        <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                          <>
                            ...
                            <Table.Cell className="font-medium text-gray-900 dark:text-white">{res.title}</Table.Cell>
                            <Table.Cell>{handleDesc(res.job_description)}</Table.Cell>
                            <Table.Cell>{handleDesc(res.job_qualification)}</Table.Cell>
                            ...
                            <Table.Cell>
                              <img src={res.company_image_url} className="max-w-xs"></img>
                            </Table.Cell>
